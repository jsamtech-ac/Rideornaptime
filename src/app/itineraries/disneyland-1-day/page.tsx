...
const UPDATED = lastUpdatedFor('/itineraries/disneyland-1-day')
...
export default function DisneylandOneDayPage() {
  return (
    <>
      <BreadcrumbJsonLd path="/itineraries/disneyland-1-day" />
      <ArticleJsonLd
        path={PAGE_PATH}
      ...
      <section className="section">
        ...
        <p className="section-intro">
          The questions families ask us most about a one-day Disneyland plan.
        </p>
