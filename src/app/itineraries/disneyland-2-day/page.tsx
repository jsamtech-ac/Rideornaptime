...
const UPDATED = lastUpdatedFor('/itineraries/disneyland-2-day')
...
export default function DisneylandTwoDayPage() {
  return (
    <>
      <BreadcrumbJsonLd path="/itineraries/disneyland-2-day" />
      <ArticleJsonLd
        path={PAGE_PATH}
      ...
      <section className="section">
        ...
        <p className="section-intro">
          The questions families ask us most about a two-day Disneyland plan.
        </p>
