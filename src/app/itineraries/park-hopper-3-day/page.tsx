...
const UPDATED = lastUpdatedFor('/itineraries/park-hopper-3-day')
...
export default function ParkHopperThreeDayPage() {
  return (
    <>
      <BreadcrumbJsonLd path="/itineraries/park-hopper-3-day" />
      <ArticleJsonLd
        path={PAGE_PATH}
      ...
      <section className="section">
        ...
        <p className="section-intro">
          The questions families ask us most about a three-day Park Hopper plan.
        </p>
