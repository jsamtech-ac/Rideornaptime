  ...
  return (
    <>
      ...
      <ArticleJsonLd
        ...
        description={"Real tips from a parent on cutting Disneyland costs — tickets, food, hotels, and souvenirs without ruining the trip."}
      ...
      <section className="section">
        ...
        <div className="tip-card">
          ...
          <p>The Disneyland Hotel and Grand Californian are beautiful but $400-700/night. Hotels on Harbor Blvd are a 10-minute walk to the gates and run $150-250/night. The money you save pays for an extra park day or <Link href="/lightning-lane">Lightning Lane</Link> for the whole family.</p>
        ...
        <div className="tip-card">
          ...
          <p>Let the kids pick one "special" park meal per day — see the <Link href="/food">food spots worth the splurge</Link>.</p>
        </div>
