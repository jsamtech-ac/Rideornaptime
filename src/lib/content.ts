...
export const RIDES: Ride[] = [
  ...
  },
  {
    ...
    heightInches: null,
    closed: true,
    closureNote: 'Closed for refurbishment since April 13, 2026. No reopening date.',
    age2: 'maybe',
    age4: 'must-do',
    age6: 'must-do',
    age8: 'must-do',
    take: 'Kids go nuts competing for high scores. Even a 2-year-old can spin the car and smash the trigger. Currently closed for refurbishment — check back before banking on it.',
    llType: 'MP',
  ...
  },
  {
    ...
    age6: 'must-do',
    age8: 'must-do',
    take: 'One small drop in the dark — some 2-year-olds cry, most love it. The queue itself is half the fun. Currently down for refurb; check before planning your day around it.',
    llType: 'MP',
  ...
  },
  {
    ...
    heightInches: 40,
    closed: true,
    closureNote: 'Closed for refurbishment since March 30, 2026.',
    age2: 'skip',
    age4: 'maybe',
    age6: 'must-do',
    age8: 'must-do',
    take: 'Spinning dark ride that gets motion-sensitive kids fast. Currently closed for refurb.',
    llType: 'MP',
    averageStandbyMin: { earlyMorning: 15, midMorning: 30, afternoon: 35, evening: 25 },
    riderSwitchUseful: true,
  },
  ...
  },
  {
    ...
    heightInches: null,
    closed: true,
    closureNote: 'Closed since January 2026. No reopening date.',
    age2: 'must-do',
    age4: 'must-do',
    age6: 'maybe',
    age8: 'skip',
    take: 'Basically a rebranded tea cups. Currently closed — no reopening date as of mid-2026.',
    llType: 'standby',
    averageStandbyMin: { earlyMorning: 10, midMorning: 25, afternoon: 30, evening: 15 },
    riderSwitchUseful: false,
  },
