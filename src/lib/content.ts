...
export const RIDES: Ride[] = [
  ...
  },
  {
    ...
    heightInches: null,
    closed: true,
    closureNote: 'Closed for refurbishment as of September 14, 2026. No reopening date announced.',
    age2: 'must-do',
    age4: 'must-do',
    age6: 'must-do',
    age8: 'maybe',
    take: "The spinning cups never get old for little kids. Let them control the wheel — they'll giggle through the whole thing. Skip if anyone in your group gets motion sick. Currently closed for refurbishment (since Sept 14, 2026) with no reopening date.",
    llType: 'standby',
  ...
  },
  {
    ...
    age6: 'maybe',
    age8: 'skip',
    take: "Gentle, slow-moving dark ride through the Hundred Acre Wood — bouncy honey-pot cars, no drops, nothing scary. Tucked next to Tiana's in Bayou Country, it stays near walk-on most of the day, so it's an easy win for little ones while a parent Rider-Switches Tiana's.",
    llType: 'standby',
    averageStandbyMin: { earlyMorning: 5, midMorning: 15, afternoon: 20, evening: 10 },
    riderSwitchUseful: false,
  },
  {
    ...
    age6: 'maybe',
    age8: 'maybe',
    take: 'A 20-minute grand-circle loop of the park with four stations (Main Street, New Orleans Square, Toontown, Tomorrowland). Toddlers love the trains, and it doubles as an air-in-the-hair stroller rest or a shortcut across the park when little legs are done. You can bring a folded stroller aboard.',
    llType: 'standby',
    averageStandbyMin: { earlyMorning: 5, midMorning: 15, afternoon: 20, evening: 10 },
    riderSwitchUseful: false,
  },
  ...
  },
  {
    ...
    age6: 'must-do',
    age8: 'must-do',
    take: 'Wave-swinger over the water — gentle and scenic. Reopened August 28, 2026 after a long refurb.',
    llType: 'standby',
  ...
  },
  {
    ...
    age6: 'maybe',
    age8: 'must-do',
    take: 'Drop tower with Star-Lord and Rocket. Genuinely scary first-time — surprise drops, loud, dark. 8+ thrill kids love it. Covered by Multi Pass.',
    llType: 'MP',
    averageStandbyMin: { earlyMorning: 25, midMorning: 55, afternoon: 65, evening: 45 },
    riderSwitchUseful: true,
  },
